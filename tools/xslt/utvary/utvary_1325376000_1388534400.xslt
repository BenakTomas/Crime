...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="ogr:OOP_final">
    <xsl:text>INSERT INTO gisdb.public.utvar_geom(valid_from, valid_to, nazev_utvaru, kr, ok, ut, pocet_obyvatel, pocet_obyvatel_trvaly_pobyt, rozloha, nazev_okresniho_utvaru, nazev_krajskeho_utvaru, hranice) VALUES(</xsl:text>
    <xsl:text>TIMESTAMP '2012-01-01'</xsl:text>
    <xsl:text>,</xsl:text>
    <xsl:text>TIMESTAMP '2014-01-01'</xsl:text>
    <xsl:text>, '</xsl:text>
