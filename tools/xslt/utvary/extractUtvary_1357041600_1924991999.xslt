...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="ogr:OOP_final">
    <xsl:text>INSERT INTO gisdb.public.utvar_geom(validFrom, validTo, nazev_utvaru, kr, ok, ut, pocet_obyvatel, pocet_obyvatel_trvaly_pobyt, rozloha, nazev_okresniho_utvaru, nazev_krajskeho_utvaru, hranice) VALUES(</xsl:text>
    <xsl:text>TIMESTAMP '2013-01-01 12:00:00'</xsl:text>
    <xsl:text>,</xsl:text>
    <xsl:text>TIMESTAMP '2030-12-31 23:59:59'</xsl:text>
    <xsl:text>, '</xsl:text>
